...
SECRET_KEY = 'g)kl6u!*f%*$vvl_c8=47!8%bd4$3psw&@6jxr26i4ga!h03op'
...
MIDDLEWARE = [
    ...
    # This middleware class sets the X-Frame-Options header to "ALLOWALL" instead of "deny", 
    # allowing your application to be displayed in an iframe on another website.
    'django_dash.middleware.XFrameOptionsMiddleware',
]
